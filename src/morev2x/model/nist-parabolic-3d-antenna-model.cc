...
NS_LOG_COMPONENT_DEFINE ("NistParabolic3dAntennaModel");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (NistParabolic3dAntennaModel);


TypeId 
NistParabolic3dAntennaModel::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::NistParabolic3dAntennaModel")
    .SetParent<AntennaModel> ()
    .AddConstructor<NistParabolic3dAntennaModel> ()
    .AddAttribute ("HorizontalBeamwidth",
                   "The 3dB beamwidth (degrees)",
                   DoubleValue (70),
                   MakeDoubleAccessor (&NistParabolic3dAntennaModel::SetHorizontalBeamwidth,
                                       &NistParabolic3dAntennaModel::GetHorizontalBeamwidth),
    ...
    .AddAttribute ("Orientation",
                   ...
                   DoubleValue (0.0),
                   MakeDoubleAccessor (&NistParabolic3dAntennaModel::SetOrientation,
                                       &NistParabolic3dAntennaModel::GetOrientation),
    ...
    .AddAttribute ("MaxHorizontalAttenuation",
                   ...
                   DoubleValue (25.0),
                   MakeDoubleAccessor (&NistParabolic3dAntennaModel::m_maxHAttenuation),
                   MakeDoubleChecker<double> ())
    .AddAttribute ("VerticalBeamwidth",
                   "The 3dB beamwidth (degrees)",
                   DoubleValue (10),
                   MakeDoubleAccessor (&NistParabolic3dAntennaModel::SetVerticalBeamwidth,
                                       &NistParabolic3dAntennaModel::GetVerticalBeamwidth),
                   MakeDoubleChecker<double> (0, 180))
    .AddAttribute ("ElectricalTilt",
                   ...
                   DoubleValue (0.0),
                   MakeDoubleAccessor (&NistParabolic3dAntennaModel::SetElectricalTilt,
                                       &NistParabolic3dAntennaModel::GetElectricalTilt),
                   MakeDoubleChecker<double> (-90, 90))
    .AddAttribute ("MechanicalTilt",
                   "The angle (degrees) that expresses the orientation of the antenna on the y-z plane relative to the y axis",
                   DoubleValue (0.0),
                   MakeDoubleAccessor (&NistParabolic3dAntennaModel::SetMechanicalTilt,
                                       &NistParabolic3dAntennaModel::GetMechanicalTilt),
                   MakeDoubleChecker<double> (-90, 90))
    .AddAttribute ("MaxVerticalAttenuation",
                   "The maximum vertical attenuation (dB) of the antenna radiation pattern.",
                   DoubleValue (20.0),
                   MakeDoubleAccessor (&NistParabolic3dAntennaModel::m_maxVAttenuation),
                   MakeDoubleChecker<double> ())
  ;
  return tid;
}
...
void 
NistParabolic3dAntennaModel::SetHorizontalBeamwidth (double horizontalBeamwidthDegrees)
{ 
...
double
NistParabolic3dAntennaModel::GetHorizontalBeamwidth () const
{
  return RadiansToDegrees (m_hBeamwidthRadians);
}

void 
NistParabolic3dAntennaModel::SetOrientation (double orientationDegrees)
{
...
double
NistParabolic3dAntennaModel::GetOrientation () const
{
  return RadiansToDegrees (m_orientationRadians);
}

void 
NistParabolic3dAntennaModel::SetVerticalBeamwidth (double verticalBeamwidthDegrees)
{ 
...
double
NistParabolic3dAntennaModel::GetVerticalBeamwidth () const
{
  return RadiansToDegrees (m_vBeamwidthRadians);
}

void 
NistParabolic3dAntennaModel::SetElectricalTilt (double electricalTiltDegrees)
{
...
double
NistParabolic3dAntennaModel::GetElectricalTilt () const
{
  return RadiansToDegrees (m_eTiltRadians);
}

void 
NistParabolic3dAntennaModel::SetMechanicalTilt (double mechanicalTiltDegrees)
{
...
double
NistParabolic3dAntennaModel::GetMechanicalTilt () const
{
...
double 
NistParabolic3dAntennaModel::GetGainDb (Angles a)
{
...
double 
NistParabolic3dAntennaModel::GetHorizontalGainDb (Angles a)
{
  NS_LOG_FUNCTION (this << a);
...
double 
NistParabolic3dAntennaModel::GetVerticalGainDb (Angles a)
{
  NS_LOG_FUNCTION (this << a);
  // azimuth angle w.r.t. the reference system of the antenna
